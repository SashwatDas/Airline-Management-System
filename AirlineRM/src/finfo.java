...
public class finfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 102, 102), new java.awt.Color(0, 0, 0), new java.awt.Color(0, 102, 102), new java.awt.Color(0, 102, 102)));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight Code", "Flight Name", "Source", "Destination", "Capacity", "Class Code", "Class Name"
            }
        ) {
        ...
        jButton2.setText("DISPLAY ALL FLIGHTS");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/plane (1).gif"))); // NOI18N
...
try{
    ...
    String s = "Select*from flight where f_code = '"+fcode+"';";
    ResultSet rs = st.executeQuery(s);
    while(rs.next()){
        String code = rs.getString("f_code");
        String name = rs.getString("f_name");
        String source = rs.getString("src");
        String des = rs.getString("dst");
        int cap = rs.getInt("capacity");
        String ccode = rs.getString("class_code");
        String cname = rs.getString("class_name");
        tm.addRow(new Object[]{code,name,source,des,cap,ccode,cname});
    }
    con.close();
    st.close();
    rs.close();
